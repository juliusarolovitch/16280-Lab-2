...
#ifndef IMAGE_SERVICE_INTERFACES__SRV__DETAIL__RETURN_IMAGE__FUNCTIONS_H_
#define IMAGE_SERVICE_INTERFACES__SRV__DETAIL__RETURN_IMAGE__FUNCTIONS_H_
...
#include "image_service_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "image_service_interfaces/srv/detail/return_image__struct.h"

/// Initialize srv/ReturnImage message.
/**
...
/// Create srv/ReturnImage message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * image_service_interfaces__srv__ReturnImage_Request__init().
...
/// Destroy srv/ReturnImage message.
/**
 * It calls
 * image_service_interfaces__srv__ReturnImage_Request__fini()
...
/// Check for srv/ReturnImage message equality.
/**
...
/// Copy a srv/ReturnImage message.
/**
...
/// Initialize array of srv/ReturnImage messages.
/**
...
/// Finalize array of srv/ReturnImage messages.
/**
 * It calls
 * image_service_interfaces__srv__ReturnImage_Request__fini()
...
/// Create array of srv/ReturnImage messages.
/**
 * It allocates the memory for the array and calls
 * image_service_interfaces__srv__ReturnImage_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ReturnImage messages.
/**
 * It calls
 * image_service_interfaces__srv__ReturnImage_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ReturnImage message array equality.
/**
...
/// Copy an array of srv/ReturnImage messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * image_service_interfaces__srv__ReturnImage_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_image_service_interfaces
...
/**
 * It calls
 * image_service_interfaces__srv__ReturnImage_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_image_service_interfaces
...
/**
 * It allocates the memory for the array and calls
 * image_service_interfaces__srv__ReturnImage_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_image_service_interfaces
...
/**
 * It calls
 * image_service_interfaces__srv__ReturnImage_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IMAGE_SERVICE_INTERFACES__SRV__DETAIL__RETURN_IMAGE__FUNCTIONS_H_
